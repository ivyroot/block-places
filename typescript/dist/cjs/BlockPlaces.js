...
class BlockPlaces {
    ...
    static lngLatBoundsFromPlaceId(placeId) {
        ...
        const placeBounds = new maplibre_gl_1.LngLatBounds(new maplibre_gl_1.LngLat(roundedLng, roundedLat), new maplibre_gl_1.LngLat(roundedLng + 0.01, roundedLat + 0.01));
        return placeBounds;
    }
    /**
    ...
    static sizedLngLatBoundsFromPlaceId(placeId, size) {
        ...
        const sizedBounds = new maplibre_gl_1.LngLatBounds(sw, ne);
        return sizedBounds;
    }
...
exports.BlockPlaces = BlockPlaces;
